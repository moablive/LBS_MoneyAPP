...
|---|---|
| Frontend (Vite) | `http://<host>:5182` |
| Backend (direto) | `http://<host>:5082` |
...
bash /mnt/nvme2tb/docker-services/server/dashboard/scripts/redeploy.sh LifeBusinessSuit/LBS_MoneyAPP
